...
# eQTL_file1 <- 'matched_all.clean-base.A-transpose-NA-NA.MxEQTL.tsv'
...
output_file_name <- sprintf('%s.LOLA', eQTL_file1)
output_file_name
####################
...
setwd('/Users/antoniob/Documents/github.dir/EpiCompBio/downstream_annotation/annotation_databases/LOLA_databases/')
